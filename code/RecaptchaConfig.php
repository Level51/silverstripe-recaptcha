...
class RecaptchaConfig extends DataExtension {
    ...
    public function updateCMSFields(\FieldList $fields) {
        ...
        $fields->addFieldToTab('Root.Recaptcha', \ReadonlyField::create('RecaptchaLink', _t('RecaptchaConfig.LINK', 'Link to admin panel'), 'https://www.google.com/recaptcha/admin'));
